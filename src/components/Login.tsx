...
import { Eye, EyeOff, Mail, Lock, User, ShieldCheck, RefreshCw, Copy, Check, RotateCcw, Sun, Moon } from 'lucide-react';
            ...
            <div className="space-y-4 pb-4 border-b border-border/30">
              ...
              <div className="p-4 bg-card border-2 border-border rounded-lg shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-semibold text-foreground">User Credentials</p>
                </div>
                <div className="space-y-1">
                  <p className="text-xs text-muted-foreground">
                    <span className="text-foreground font-medium">Email:</span> jakaria455173@gmail.com
                  </p>
                  <p className="text-xs text-muted-foreground">
                    <span className="text-foreground font-medium">Password:</span> demo123
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 bg-card border-2 border-border rounded-lg shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-semibold text-foreground">Admin Credentials</p>
                </div>
                <div className="space-y-1">
                  <p className="text-xs text-muted-foreground">
                    <span className="text-foreground font-medium">Email:</span> admin@taskflow.com
                  </p>
                  <p className="text-xs text-muted-foreground">
                    <span className="text-foreground font-medium">Password:</span> admin123
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="space-y-2 p-3 border-2 border-border/30 rounded-lg bg-muted/20">
                      ...
                      <div className="grid grid-cols-2 gap-1 text-xs">
                        ...
                        <div className={`flex items-center gap-1 ${passwordValidation.hasSpecialChar ? 'text-green-600' : 'text-red-600'}`}>
                          <div className={`w-2 h-2 rounded-full ${passwordValidation.hasSpecialChar ? 'bg-green-600' : 'bg-red-600'}`} />
                          Special character
                        </div>
                      </div>
                    </div>
