...
export default function DashboardPage() {
  ...
  const getTabConfig = (tab: string) => {
    switch (tab) {
      ...
      case 'all':
        return { component: <TaskList status="all" title="All Tasks" />, title: 'All Tasks' };
      case 'pending':
        return { component: <TaskList status="pending" title="Pending Tasks" />, title: 'Pending Tasks' };
      case 'completed':
        return { component: <TaskList status="completed" title="Completed Tasks" />, title: 'Completed Tasks' };
      case 'overdue':
        return { component: <TaskList status="overdue" title="Overdue Tasks" />, title: 'Overdue Tasks' };
      case 'profile':
